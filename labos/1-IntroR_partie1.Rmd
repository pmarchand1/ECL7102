...
Il est possible de remplacer certains éléments d'un vecteur (ou d'une colonne d'un tableau de données) en combinant la sélection et l'assignation de valeur. Le code suivant remplace les valeurs de DHP inférieures à 1 par la valeur 1.
