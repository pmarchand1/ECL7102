...
Estimez les paramètres du modèle linéaire de `logSize` en fonction du nombre de jours écoulé et répondez aux questions suivantes: (i) Comment interprétez-vous l'ordonnée à l'origine de ce modèle? (ii) Quelle est la variation moyenne de `logSize` entre le jour 152 et le jour 201 et quel est son erreur-type?
