...
Ce laboratoire doit être remis le **6 novembre à 17h sur Moodle**. Dans votre réponse pour chaque question, veuillez inclure une copie du code R utilisé (s'il y a lieu) et des résultats obtenus. 
...
Combien de modèles ont un $\Delta AIC \le 2$? Selon les poids d'Akaike, quelle est la probabilité qu'un ou l'autre de ces modèles soit le meilleur modèle?
