...
Answers for this lab must be submitted before **November 11th at 5pm on Moodle**. In your answer for each question, please include a copy of the R code used (if applicable) and the results obtained.
