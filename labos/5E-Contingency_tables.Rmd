...
Answers for this lab must be submitted before **October 3rd at 5pm on Moodle**. In your answer for each question, please include a copy of the R code used (if applicable) and the results obtained.
...
b) Does the presence of a large tree affect the energy cost of a home?

c) Does the distribution of planted tree species differ between neighborhoods?
