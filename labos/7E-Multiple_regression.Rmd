...
c) Repeat the model in (b) by adding the interaction between the weight (standardized) and the environment. What is the interpretation of the coefficients? Is the interaction significant?
