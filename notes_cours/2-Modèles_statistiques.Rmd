...
La solution de ce problème a été découverte par William Gosset, qui l'a publié sous le pseudonyme de Student. Lorsqu'on utilise un estimé de l'écart-type, $\bar{x} - s / \sqrt{n}$ ne suit plus exactement une distribution normale centrée réduite, mais plutôt la distribution $t$ de Student.
