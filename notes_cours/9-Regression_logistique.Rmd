...
- Utiliser la régression logistique pour modéliser une réponse binaire (ex.: présence/absence), une réponse binomiale (ex.: nombre de présences et d'absences) ou des proportions.
