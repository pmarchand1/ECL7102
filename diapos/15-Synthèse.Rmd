...
# Échantillonnage et plans expérimentaux
...
<img src="../images/synthese_anova.png" width="80%">
...
## Suppositions de la régression linéaire
...
- $y$: réponse numérique
- $w$ et $x$: prédicteurs numériques
- $z$: facteur avec codage de traitement et niveaux A (référence), B et C
...
- *w*: Effet sur $y$ si $w$ augmente de 1, $x$ et $z$ restent constants.
- *x*: Effet sur $y$ si $x$ augmente de 1, $w$ et $z$ restent constants.
